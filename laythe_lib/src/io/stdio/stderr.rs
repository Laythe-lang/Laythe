...
pub fn declare_stderr(hooks: &GcHooks, module: Ref<Module>, package: Ref<Package>) -> StdResult<()> {
...
pub fn define_stderr(hooks: &GcHooks, module: Ref<Module>, package: Ref<Package>) -> StdResult<()> {
