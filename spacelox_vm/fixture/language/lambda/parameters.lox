...
var f3 = |a, b, c| { return a + b + c; };
print f3(1, 2, 3); // expect: 6

var f4 = |a, b, c, d| { return a + b + c + d; };
print f4(1, 2, 3, 4); // expect: 10

var f5 = |a, b, c, d, e| { return a + b + c + d + e; };
print f5(1, 2, 3, 4, 5); // expect: 15

var f6 = |a, b, c, d, e, f| { return a + b + c + d + e + f; };
print f6(1, 2, 3, 4, 5, 6); // expect: 21

var f7 = |a, b, c, d, e, f, g| { return a + b + c + d + e + f + g; };
print f7(1, 2, 3, 4, 5, 6, 7); // expect: 28

var f8 = |a, b, c, d, e, f, g, h| { return a + b + c + d + e + f + g + h; };
